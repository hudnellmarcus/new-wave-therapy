  ...
  return (
    <section className="py-24 bg-black text-white overflow-hidden">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="relative">
          <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-nwt-light-teal via-nwt-coral to-nwt-peach"></div>
          
          <div className="space-y-12">
            <div className="flex items-start gap-8">
              <div className="flex-shrink-0 w-16 h-16 bg-nwt-light-teal rounded-full flex items-center justify-center text-black font-bold text-xl">
                1
              </div>
              <div className="pt-2">
            ...
            <div className="flex items-start gap-8">
              <div className="flex-shrink-0 w-16 h-16 bg-nwt-coral rounded-full flex items-center justify-center text-white font-bold text-xl">
                2
              </div>
              <div className="pt-2">
            ...
            <div className="flex items-start gap-8">
              <div className="flex-shrink-0 w-16 h-16 bg-nwt-peach rounded-full flex items-center justify-center text-black font-bold text-xl">
                3
              </div>
              <div className="pt-2">
